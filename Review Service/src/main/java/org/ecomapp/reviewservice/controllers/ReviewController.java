package org.ecomapp.reviewservice.controllers;
...
import org.ecomapp.reviewservice.service.ReviewService;
...
public class ReviewController {
    ...
    public ResponseEntity<ReviewResponseDTO> createReview(@RequestHeader("X-User-Id") Long userId,
                                                          @PathVariable Long productId,
                                                          @PathVariable Long orderItemId,
                                                          @Valid @RequestBody ReviewRequestDTO reviewRequestDTO) {
        return new ResponseEntity<>(reviewService.createReview(userId, productId, orderItemId, reviewRequestDTO), HttpStatus.CREATED);
    }

    @Operation(summary = "Update review")
    @PatchMapping("/{reviewId}")
    public ResponseEntity<ReviewResponseDTO> updateReview(@RequestHeader("X-User-Id") Long userId,
                                                          @PathVariable Long reviewId,
                                                          @Valid @RequestBody UpdateReviewRequestDTO updateReviewRequestDTO) {
        return new ResponseEntity<>(reviewService.updateReview(userId, reviewId, updateReviewRequestDTO), HttpStatus.OK);
    }
}
