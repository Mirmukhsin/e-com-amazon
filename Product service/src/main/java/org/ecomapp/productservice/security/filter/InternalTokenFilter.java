package org.ecomapp.productservice.security.filter;
...
import org.ecomapp.productservice.security.TokenValidator;
import org.ecomapp.productservice.security.config.InternalAuthentication;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (version == null || version < 1) {
                System.out.println("8484446646464846486468468");
