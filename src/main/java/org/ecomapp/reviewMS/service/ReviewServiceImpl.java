...
public class ReviewServiceImpl implements ReviewService {
    ...
    public ReviewResponseDTO createReview(Long productId, Long orderItemId, ReviewRequestDTO reviewRequestDTO) {
        ...
        boolean alreadyReviewed = reviewRepository.existsByOrderItem_IdAndBuyer_Id(orderItemId, reviewRequestDTO.getBuyerId());
        ...
        User buyer = userRepository.findById(reviewRequestDTO.getBuyerId()).orElseThrow(() -> new ResourceNotFoundException("User not found"));
        ...
        if (!orderItem.getSubOrder().getOrder().getBuyer().getId().equals(reviewRequestDTO.getBuyerId())) {
