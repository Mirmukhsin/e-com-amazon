...
import org.ecomapp.paymentservice.services.refundService.RefundService;
...
public class RefundController {
    ...
    public ResponseEntity<RefundResponseDTO> requestRefund(@RequestHeader("X-User-Id") Long userId,
                                                           @PathVariable Long subOrderId,
                                                           @Valid @RequestBody RefundRequestDTO refundRequestDTO) {

        return new ResponseEntity<>(refundService.requestRefund(userId, subOrderId, refundRequestDTO), HttpStatus.CREATED);
    }
